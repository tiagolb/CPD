...
void lcsPopulateMatrix_line(std::string & seq1, std::string & seq2,
							short ** matrix, size_t & lines, size_t & cols) {
...
//std::vector< std::vector<short> >
void lcsPopulateMatrix_col(std::string & seq1, std::string & seq2,
						   short ** matrix, size_t & lines, size_t & cols) {
	// size_t lines = seq1.size()+1;
	// size_t cols = seq2.size()+1;
...
int main(int argc, char* argv[]) {
	...
	if(seq1.size() > seq2.size()) {
 		lcsPopulateMatrix_col(seq1, seq2, matrix, lines, cols);
	} else {
		lcsPopulateMatrix_line(seq1, seq2, matrix, lines, cols);
	}
